...
const createInvoice = z.object({
    ...
    items: z.array(z.object({
        product_id: z.number().int({ message: 'ID del producto debe ser un número entero' }).positive({ message: 'product_id debe ser un número positivo' }),
        quantity: z.number().int({ message: 'Cantidad debe ser un número entero' }).positive({ message: 'quantity debe ser un número positivo' })
